...
select first_name || last_name as fullname from employees order by length(fullname) desc;
...
select min(length(first_name || last_name)) from employees;
select round(avg(length(first_name || last_name))) from employees;

select max(length(first_name || last_name)), 
min(length(first_name || last_name)), round(avg(length(first_name || last_name))) from employees;
...
select first_name, last_name from employees where length(last_name) = 4 order by first_name;
